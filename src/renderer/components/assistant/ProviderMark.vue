...
const MARKS: Partial<Record<AiDriverKind, readonly Part[]>> = {
  ...
  // Moonshot's mark: the crescent and the stroke through it.
  kimi: [
    {
  ...
  // Six strokes meeting at a point.
  qwen: [
    {
  ...
  // Zhipu's, which is what GLM is shipped under.
  glm: [
    {
